...
! function(t, i) {
    ...
    function n(t) {
        if (!t._start) try {
            ...
            if (t._tasks[t._ended + t._active - 1]) a(t, i);
            else if (!t._data) throw i
        }
    }
    ...
    function r(t) {
        for (; t._start = t._waiting && t._active < t._size;) {
            var i = t._ended + t._active,
                ...
                r = n.length - 1,
                a = n[r];
            n[r] = e(t, i), --t._waiting, ++t._active, n = a.apply(null, n), t._tasks[i] && (t._tasks[i] = n || c)
        }
    }

    function e(t, i) {
        return function(r, e) {
            t._tasks[i] && (--t._active, ++t._ended, t._tasks[i] = null, null == t._error && (null != r ? a(t, r) : (t._data[i] = e, t._waiting ? n(t) : s(t))))
        }
    }

    function a(t, i) {
        var n, r = t._tasks.length;
        for (t._error = i, t._data = void 0, t._waiting = NaN; --r >= 0;)
            if ((n = t._tasks[r]) && (t._tasks[r] = null, n.abort)) try {
                n.abort()
            } catch (t) {}
            t._active = NaN, s(t)
    }
    ...
    function s(t) {
        if (!t._active && t._call) {
            var i = t._data;
            t._data = void 0, t._call(t._error, i)
        }
    }
    ...
    i.prototype = o.prototype = {
        ...
        defer: function(t) {
            ...
            return i.push(t), ++this._waiting, this._tasks.push(i), n(this), this
        },
        abort: function() {
    ...
    }, t.queue = o, Object.defineProperty(t, "__esModule", {
        value: !0
    })
});