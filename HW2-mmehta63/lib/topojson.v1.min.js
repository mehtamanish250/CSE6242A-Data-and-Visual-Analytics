! function(n, t) {
    ...
    function c(n, t) {
        function e(n, t) {
            t.length && t.pop();
            for (var r, e = l[n < 0 ? ~n : n], i = 0, u = e.length; i < u; ++i) t.push(r = e[i].slice()), s(r, i);
            n < 0 && o(t, u)
        }
    ...
    function l(n, t, r) {
        ...
        if (arguments.length > 1) {
            ...
            for (var h = 0, p = n.arcs.length; h < p; ++h) f.push(h);
        return {
        ...
        return t.forEach(function(n) {
            ...
            arcs: u.map(function(t) {
                ...
                if (t.forEach(function(n) {
                    ...
                    for (var u, f, c = 1, s = e(i[0]); c < r; ++c)(u = e(i[c])) > s && (f = i[0], i[0] = i[c], i[c] = f, s = u);
                return i
            })
        }
    }
    ...
    function d(n) {
        ...
        n.forEach(e);
        for (var c in o)
            for (var a = o[c], s = a.length, l = 0; l < s; ++l)
                for (var h = l + 1; h < s; ++h) {
                    var p, v = a[l],
                        g = a[h];
    ...
    function m() {
        ...
        function t(n, t) {
            for (;;) {
                var r = t + 1 << 1,
                    ...
                    u = t,
                    f = e[u];
                if (i < o && y(e[i], f) < 0 && (f = e[u = i]), r < o && y(e[r], f) < 0 && (f = e[u = r]), u === t) break;
        ...
        return r.push = function(t) {
            ...
            var i, u = r._;
            if (e[u] === r) return u !== --o && (i = e[o], (y(i, r) < 0 ? n : t)(e[i._ = u] = i, u)), u
        }, r
    }
    ...
    function E(n, t) {
        ...
        return t || (t = h), n.arcs.forEach(function(n) {
            var r, e, c, a, s = [],
                l = 0;
            for (e = 0, c = n.length; e < c; ++e) a = n[e], i(n[e] = [a[0], a[1], 1 / 0], e);
            for (e = 1, c = n.length - 1; e < c; ++e) r = n.slice(e - 1, e + 2), r[1][2] = t(r), s.push(r), f.push(r);
    ...
    var M = "1.6.27";
    n.version = M, n.mesh = s, n.meshArcs = l, n.merge = v, n.mergeArcs = g, n.feature = u, n.neighbors = d, n.presimplify = E, Object.defineProperty(n, "__esModule", {
        value: !0
    })
});